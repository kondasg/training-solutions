...
public class EmployeeTest {
    ...
    @Test
    public void testCreateNonThosandSalary() {
        Exception ex = assertThrows(IllegalArgumentException.class, () -> new Employee("Kis Géza", "minőségellenőr", 520001));
        assertEquals("Salary must be divisible by 1000.", ex.getMessage());
    }
